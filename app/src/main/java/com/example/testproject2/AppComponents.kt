...
import com.example.testproject2.ui.theme.BgSocial
import com.example.testproject2.ui.theme.BorderColor
import com.example.testproject2.ui.theme.BrandColor
import com.example.testproject2.ui.theme.Primary
import com.example.testproject2.ui.theme.Tertirary
...
fun MyTextField(
    ...
    var textVal by rememberSaveable { mutableStateOf("") }

    val typeOfKeyboard: KeyboardType = when (labelVal.lowercase(Locale.getDefault())) {
        "email id", "email" -> KeyboardType.Email
        "mobile", "phone", "mobile no", "mobile number" -> KeyboardType.Phone
    ...
    OutlinedTextField(
        ...
        colors = OutlinedTextFieldDefaults.colors(
            ...
            /* placeholder / icons */
            focusedPlaceholderColor = Tertirary,
            unfocusedPlaceholderColor = Tertirary,
            focusedLeadingIconColor = BrandColor,
            unfocusedLeadingIconColor = Tertirary,
            focusedTrailingIconColor = Tertirary,
            unfocusedTrailingIconColor = Tertirary,
            /* cursor */
        ...
        leadingIcon = {
            Icon(
                ...
                contentDescription = "$labelVal icon",
                tint = Tertirary
            )
        },
...
fun PasswordInputComponent(
    ...
    OutlinedTextField(
        ...
        colors = OutlinedTextFieldDefaults.colors(
            ...
            focusedPlaceholderColor = Tertirary,
            unfocusedPlaceholderColor = Tertirary,
            focusedLeadingIconColor = Tertirary,
            unfocusedLeadingIconColor = Tertirary,
            focusedTrailingIconColor = Tertirary,
            unfocusedTrailingIconColor = Tertirary,
            /* cursor */
        ...
        trailingIcon = {
            ...
            val iconImage = if (isPasswordVisible) R.drawable.pheyeclosedfill__1_ else R.drawable.eye_closed
